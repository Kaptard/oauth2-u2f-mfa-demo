...
module.exports = {
  ...
  plugins: (isProd ? [
    ...
    new webpack.DefinePlugin({
      '$apiUrl': JSON.stringify(isProd ? 'wss://api.kaptard.io/ws' : cubic.config.ui.client.apiUrl),
      '$authUrl': JSON.stringify(isProd ? 'wss://auth.kaptard.io/ws' : cubic.config.ui.client.authUrl)
    })
  ])
}
